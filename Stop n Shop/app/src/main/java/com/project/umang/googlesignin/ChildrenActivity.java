    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ChildrenActivity.this, "Fetching Data", "Wait...", false, false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(Config.URL_GETCHILD);
                return s;
            }
        }
    ...
    private void showMen() {
        ...
        recyclerView.addOnItemTouchListener(new CustomRVItemTouchListener(this, recyclerView, new RecyclerViewItemClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent= new Intent(ChildrenActivity.this,Details.class);
